...
# Define que estou criando uma classe com nome "Girafa"
# Começa sempre com a palavra maiúscula.
class Girafa: 
    # Propriedades
    
    # O método __Init__ é é executado quando 
    ...
    def andar(self):
        if self.__fome > 60:
            print(self.nome, "não pode andar pois está morrendo de fome!!")
        else:
